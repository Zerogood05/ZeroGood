...
const FLAG_MAP: { bit: number; name: string; icon: string }[] = [
  ...
  { bit: 1 << 2,  name: "HypeSquad Events",     icon: "/badges/hypesquad-events.svg" },
  { bit: 1 << 3,  name: "Bug Hunter",           icon: "/badges/bug-hunter.svg" },
  { bit: 1 << 6,  name: "HypeSquad Bravery",    icon: "/badges/hypesquad-bravery.svg" },
  { bit: 1 << 7,  name: "HypeSquad Brilliance", icon: "/badges/hypesquad-brilliance.svg" },
  { bit: 1 << 8,  name: "HypeSquad Balance",    icon: "/badges/hypesquad-balance.svg" },
